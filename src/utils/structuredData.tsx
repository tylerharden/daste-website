...
export const getEventSchema = (event: EventSchemaInput) => ({
  '@context': 'https://schema.org',
  '@type': 'MusicEvent',
...
export const getEventsListSchema = (events: EventSchemaInput[]) => ({
  '@context': 'https://schema.org',
  '@type': 'ItemList',
...
export const StructuredData = ({ data }: { data: unknown }): JSX.Element => {
